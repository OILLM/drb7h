...
client.on('interactionCreate', async (interaction) => {
  if (interaction.isButton()) {
    if(!interaction.member.roles.cache.has('1238209414075256893')) return interaction.reply('عندك خطاء ');
...
client.login("MTIzODQ2MzQzNjE3MDQ2NTMyMA.GQZT0m.jgdeZHwMZxNk5dVotXz3aOmISLxuiNBZJczlwE");